        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/ZangeressenController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="aantalalbums" type="number" min="0" max="100" class="form-control <?= isset($data['errors']['aantalalbums']) ? 'is-invalid' : ''; ?>" id="aantalalbums" value="<?= $_POST['aantalalbums'] ?? ''; ?>">
