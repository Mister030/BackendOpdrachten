...
<div class="container">
    ...
    <div class="row mt-3 d-flex justify-content-center">
        <div class="col-10">
                    ...
                    <?php foreach ($data['result'] as $horloge) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo URLROOT; ?>/HorlogeController/update/<?php echo $horloge->Id; ?>">
            ...
            <a href="<?php echo URLROOT; ?>/HorlogeController/create" class="btn btn-success">
                Nieuw horloge toevoegen
            </a>
